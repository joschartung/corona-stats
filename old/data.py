...
confirmed_df = confirmed_df.groupby(confirmed_df['Country/Region']).aggregate(np.sum)
deaths_df = deaths_df.groupby(deaths_df['Country/Region']).aggregate(np.sum)
recovered_df = recovered_df.groupby(recovered_df['Country/Region']).aggregate(np.sum)
